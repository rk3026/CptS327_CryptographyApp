    ...
    public partial class FileEncryptionTab : UserControl
    {
        ...
        private void buttonCreateAsmKeys_Click(object sender, EventArgs e)
        {
            ...
            label1.Text = _rsa.PublicOnly
                ? $"PublicKey: {_cspp.KeyContainerName} - Public Only"
                : $"PublicKey: {_cspp.KeyContainerName} - Full PublicKey Pair";
        }
        ...
        private void buttonEncryptFile_Click(object sender, EventArgs e)
        {
            if (_rsa is null)
            {
                MessageBox.Show("PublicKey not set.");
            }
            else
            {
